...
@dp.expect("valid_latitude", "property_latitude BETWEEN -90 AND 90")
...
@dp.materialized_view(
    name="silver_reviews",
    comment="Cleaned reviews with booking and property context, excluding deleted"
)
...
# MAGIC %md
# MAGIC ## Junction & Activity Tables
